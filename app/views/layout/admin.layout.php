    ...
    <div class="app-container">
        ...
        <div class="sidebar">
            <div class="logo-container">
                ...
                <p class="promotion">
                    <?php
                    if (isset($active_promotion) && $active_promotion) {
                        echo "Promotion " . htmlspecialchars($active_promotion['name']);
                    } else {
                        echo "Pas de promotion active";
                    }
                    ?>
                </p>
            </div>
            ...
            <header class="top-header">
                ...
                <div class="user-menu">
                    ...
                    <div class="user-profile">
                        <div class="user-info">
                            <span class="user-name"><?= isset($user['email']) ? $user['email'] : 'Utilisateur' ?></span>
